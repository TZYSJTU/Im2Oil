...
class ETF():
    def __init__(self, img, output_path, kernel_radius, iter_time, background_dir=None):
...
if __name__ == '__main__':
    ...
    ETF_filter = ETF(input_path=input_path, output_path=output_path, kernel_radius=kernel_radius, iter_time=30)
    ETF_filter.forward()
    print('done')